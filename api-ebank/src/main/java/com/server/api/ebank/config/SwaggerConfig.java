...
@Configuration
@OpenAPIDefinition(info = @Info(title = "EBANK API", version = "1.0", description = "Documentation API REST pour le système EBANK", contact = @Contact(name = "Admin EBANK", email = "admin@gmail.com", url = "http://localhost:8080"), license = @License(name = "EBANK License", url = "http://localhost:8080"), termsOfService = "Utilisation réservée au système EBANK"), servers = {
